...
## 1. Исправить patch fetch — он не работает
...
## 2. Починить вкладку Samples — понять что работает, что нет, привести в порядок
...
## 3. Реализовать SysEx-обновление параметров при изменении кнобов в редакторе патча
